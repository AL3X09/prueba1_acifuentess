			...
			<div class="row">
				<div class="col-md-12">
					<div class="text-center">
						<h1 class="text-blue pb-2 fw-bold">DASHBOARD</h1>
					</div>
				</div>
			</div>
				...
				<div class="col-md-4">
					<div class="card" style="width: 18rem;">
						...
						<div class="card-body">
							...
							<a href="Ejer1" class="btn btn-primary">Abrir</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="card" style="width: 18rem;">
						...
						<h5 class="card-title">Ejercicio 2</h5>
							...
							<a href="Ejer2" class="btn btn-primary">Abrir</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-4">
					<div class="card" style="width: 18rem;">
						...
						<h5 class="card-title">Ejercicio 3</h5>
							...
							<a href="Ejer3" class="btn btn-primary">Abrir</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
				...
				<div class="col-md-4">
					<div class="card" style="width: 18rem;">
						...
						<h5 class="card-title">Ejercicio 5</h5>
							<p class="card-text">
								Se debe realizar una consulta tipo Rest al API de banco de MX del tipo de cambio de los
								últimos 5 días y mostrarlo en una tabla con fecha y tipo de cambio, a través de una página html básica
							</p>
							<a href="Ejer5" class="btn btn-primary">Abrir</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
...
<!-- JS pagina 	-->
<script src="<?= base_url(); ?>/public/assets/js/paginas/home.js"></script>